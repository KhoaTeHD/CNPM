...
public class PhieuNhapPanel extends javax.swing.JPanel {
    ...
    public PhieuNhapPanel() {
        ...
        mdtb1 = (DefaultTableModel) tbPhieuNhap.getModel();
        setDataToTable(qlpn.getDspn());
        
        tbPhieuNhap.addMouseListener(new MouseAdapter() { // copy từ HienThiSanPham
            @Override
            public void mouseReleased(MouseEvent me) {
                String mapn = (String) tbPhieuNhap.getValueAt(tbPhieuNhap.getSelectedRow(), 1);
                if (mapn != null) {
                    showInfo(mapn);
                }
            }
    ...
    private void initComponents() {
        ...
        tfNhaCC.setPreferredSize(new java.awt.Dimension(170, 40));
        jPanel9.add(tfNhaCC);
        ...
        tbPhieuNhap.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        tbPhieuNhap.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "STT", "Mã phiếu nhập", "Mã nhà cung cấp", "Mã nhân viên", "Ngày nhập", "Tổng tiền"
            }
        ));
        tbPhieuNhap.setFillsViewportHeight(true);
        tbPhieuNhap.setRowHeight(40);
        tbPhieuNhap.getTableHeader().setFont(new Font("Segoe UI", Font.BOLD, 16));
        tbPhieuNhap.setShowGrid(true);
        jScrollPane1.setViewportView(tbPhieuNhap);
        if (tbPhieuNhap.getColumnModel().getColumnCount() > 0) {
            tbPhieuNhap.getColumnModel().getColumn(0).setMaxWidth(70);
            tbPhieuNhap.getColumnModel().getColumn(1).setMaxWidth(210);
            tbPhieuNhap.getColumnModel().getColumn(2).setMaxWidth(210);
            tbPhieuNhap.getColumnModel().getColumn(3).setMaxWidth(210);
            tbPhieuNhap.getColumnModel().getColumn(4).setMaxWidth(210);
            tbPhieuNhap.getColumnModel().getColumn(5).setMaxWidth(210);
        }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        thempn.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent e) {
                qlpn.readDB();
                setDataToTable(qlpn.getDspn()); // refresh
            }
        });
    ...
    private void btnPrintPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintPDFActionPerformed
            ...
            if (tbPhieuNhap.getSelectedRow() != -1) {
                new WritePDF().writePhieuNhap(String.valueOf(tbPhieuNhap.getValueAt(tbPhieuNhap.getSelectedRow(), 1)));
            } else {
    ...
    private void setDataToTable(ArrayList<PhieuNhap> data) {
        ...
        if (mapn != null) {
            ...
            for (PhieuNhap pn : qlpn.getDspn()) {
                if (pn.getMaPN().equals(mapn)) {
                    ...
                    tfMaPhieuNhap.setText(pn.getMaPN());
                    tfNhaCC.setText(tenncc + " - " + pn.getMaNCC());
                    tfNhanVien.setText(tennhanvien + " - " + pn.getMaNV());
                    tfNgayLap.setText(pn.getNgayNhap().toString());
                    tfTongTien.setText(PriceFormatter.format(pn.getTongTien()));
                    return;
                }
            }
        }
    ...
    private void tfSearchOnChange() {
        ...
        setDataToTable(qlpn.search(cbTypeSearch.getSelectedItem().toString(), tfTim.getText(), ngay1, ngay2, tong1, tong2));
    }
