...
import GUI.ChonFrame.ChonNhanVien;
...
public class ThemSuaPhieuNhapForm extends JFrame {
    ...
    private void btnThemMouseClicked() {
        if (checkEmpty()) {
            ...
            if (qlpnBUS.add(mapn, mancc, manv, ngayNhap, tongTien)) {
    ...
    private void btnSuaMouseClicked() {
        if (checkEmpty()) {
            ...
            if (qlpnBUS.update(mapn, mancc, manv, ngayNhap, tongTien)) {
    ...
    private void btnChonNhaCungCapMouseClicked() {
        ChonNhaCungCap cncc = new ChonNhaCungCap(txtMaNCC);
    }
