...
public class TacGiaPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tbTacGia.getTableHeader().setFont(new Font("Segoe UI", Font.BOLD, 16));
        ...
        if (tbTacGia.getColumnModel().getColumnCount() > 0) {
            ...
            tbTacGia.getColumnModel().getColumn(1).setMaxWidth(250);
            tbTacGia.getColumnModel().getColumn(2).setMaxWidth(500);
            tbTacGia.getColumnModel().getColumn(3).setMaxWidth(500);
        }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        themtg.addWindowListener(new java.awt.event.WindowAdapter() {
            ...
            public void windowClosed(java.awt.event.WindowEvent windowEvent) {
                qltgBUS.readDB();
                setDataToTable(qltgBUS.getDstg()); //refresh
            }
        });
    ...
    private void btnXuatExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXuatExcelActionPerformed
        new XuatExcel().xuatFileExcelTacGia();
    }//GEN-LAST:event_btnXuatExcelActionPerformed

    private void btnNhapExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapExcelActionPerformed
        new DocExcel().docFileExcelTacGia();
