 ...
 * @author dangk
 */
public class ChonNhaXuatBan extends javax.swing.JFrame {
     ...
     */
    public ChonNhaXuatBan(JTextField tf) {
        initComponents();
    ...
    private void initComponents() {
        ...
        if (tbNXB.getColumnModel().getColumnCount() > 0) {
            ...
            tbNXB.getColumnModel().getColumn(1).setMaxWidth(120);
            tbNXB.getColumnModel().getColumn(2).setMaxWidth(400);
            tbNXB.getColumnModel().getColumn(3).setMaxWidth(400);
        }
